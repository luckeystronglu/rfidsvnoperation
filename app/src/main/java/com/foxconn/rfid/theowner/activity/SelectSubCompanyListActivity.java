...
public class SelectSubCompanyListActivity extends BaseActivity implements Header.headerListener,
        ...
        mCompanyAdapter.setOnRVItemClickListener(new BGAOnRVItemClickListener() {
            ...
            public void onRVItemClick(ViewGroup parent, View itemView, int position) {
                if (mCompanyAdapter.getItem(position).getHasChild().equals("0")) {
                    ...
                    ActivityManager.getInstance().finishActivities(SelectCompanyActivity.class);
                    ActivityManager.getInstance().finishActivities(SelectSubCompanyListActivity
                            .class);
                    finish();
                ...
                if (mCompanyAdapter.getItem(position).getHasChild().equals("1")) {
                    ...
                    intent.setClass(mContext, SelectSubCompanyListActivity.class);
        ...
        try {
            ...
            if (eventPackage.getCommandId() == SocketAppPacket.GET_COMPANY_LIST) {
                ...
                if (responseMessage.getErrorMsg().getErrorCode() != 0) {
                    Toast.makeText(SelectSubCompanyListActivity.this, responseMessage.getErrorMsg()
